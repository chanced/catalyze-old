use super::{enums::*, Interface};
use core::fmt::Debug;
use std::{fmt::Display, ops::Deref, slice};

// /// Describes a complete .proto file.
// pub trait FileDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait MessageDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait EnumDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     fn name(&self) -> String;
...
// pub trait EnumValueDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     fn name(&self) -> String;
//     fn number(&self) -> i32;
...
// pub trait FieldDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     fn name(&self) -> String;
//     fn number(&self) -> i32;
//     fn label(&self) -> Label;
...
// pub trait ServiceDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     fn name(&self) -> String;
...
// pub trait MethodDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     fn name(&self) -> String;
//     /// Input type name.
//     ///
...
// pub trait OneofDescriptor<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     fn name(&self) -> String;
...
// pub trait FileOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait EnumValueOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait MessageOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait FieldOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait EnumOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait ServiceOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
...
// pub trait MethodOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     // Note:  Field numbers 1 through 32 are reserved for Google's internal RPC
...
// pub trait OneofOptions<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     /// The parser stores options it doesn't recognize here. See above.
//     fn uninterpreted_options(&self) -> I::UninterpretedOptionsIter;
// }
...
// pub trait ReservedRange<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     /// Inclusive.
//     fn start(&self) -> i32;
...
// pub trait ExtensionRange<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     /// Inclusive.
//     fn start(&self) -> i32;
//     /// Exclusive.
//     fn end(&self) -> i32;
...
// pub trait EnumReservedRange<'a, I: Interface<'a>>: Clone + Copy + Debug {
//     /// Inclusive
//     fn start(&self) -> i32;
//     /// Inclusive
//     fn end(&self) -> i32;
...
// pub trait EnumReservedRanges<'a, I: Interface<'a>>:
//     Clone
//     + Copy
//     + Debug
...
// pub trait UninterpretedOption<'a, I: Interface<'a>>:
...
//     fn aggregate_value(&self) -> String;
// }
...
// pub trait NameParts<'a, I: Interface<'a>>:
...
//         self.len() == 0
//     }
//     fn iter(&self) -> I::NamePartIter {
//         self.into_iter()
//     }
//     fn formatted_value(&self) -> String {
//         let i = self.iter();

//         i.map(|np| np.formatted_value())
//             .collect::<Vec<String>>()
//             .join(".")
//     }
// }
...
// //
// pub trait NamePart<'a, I: Interface<'a>>:
//     Debug
//     + ToString
//     + Display
//     + Eq
...
// pub trait SourceCodeInfo<'a, I: Interface<'a>>:
//     Clone + Copy + Debug + IntoIterator<Item = I::Location, IntoIter = I::LocationIter>
// {
...
// pub trait Location<'a, I: Interface<'a>> {
